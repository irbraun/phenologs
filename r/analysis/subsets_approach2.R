...
run_one_method <- function(pred_column_name, phenotype_network, subsets_df, subset_name_list){
...
mclapply(PRED_COLUMN_NAMES, run_one_method, phenotype_network=phenotype_network, subsets_df=subsets_df, subset_name_list=subset_name_list, mc.cores=numCores)
