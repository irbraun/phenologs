...
# Generates slurm submit scripts for learn_otherprobs.R
...
classprobs_filename = base_dir+sys.argv[6]
classprobs_id = sys.argv[7]
ontology = sys.argv[8]
...
f.write("%s %s %s"%(split_postfix, classprobs_filename, classprobs_id))
f.close()